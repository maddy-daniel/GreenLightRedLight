...
class ViewModelFactory(private  val entryDao: EntryDao) : ViewModelProvider.Factory {       //ViewModelProvider.Factory: An Android interface that tells the system how to create your ViewModel
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {                  //create() function: Android calls when it needs a new BudgetViewModel
        if(modelClass.isAssignableFrom(BudgetViewModel::class.java)) {
            ...
            return BudgetViewModel(entryDao) as T
        }
